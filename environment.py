...
class PokingEnv(object):
    ...
    def longpoke(self, poke_len_min, save_dir, poke_num=100):
        ...
        for poke_index in range(poke_num):
            ...
            box_id2 = self.load_box(pos=[end_x, end_y, self.box_z], rgba=[0,0, 1,0.5])
            p.setCollisionFilterPair(self.box_id, box_id2, -1, -1, enableCollision=0)
            ...
            self.remove_box(box_id2) # remove target 
